import { Configuration, RequestContext, ResponseContext, V1APIResource, V1APIResourceList, V1DeleteOptions, V1Status } from '@kubernetes/client-node/dist/api.js';
import { KubeConfig } from '@kubernetes/client-node/dist/config.js';
import { KubernetesListObject, KubernetesObject } from '@kubernetes/client-node/dist/types.js';
