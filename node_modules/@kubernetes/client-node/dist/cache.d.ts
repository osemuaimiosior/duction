import { ADD, CHANGE, CONNECT, DELETE, ERROR, ErrorCallback, Informer, ListPromise, ObjectCallback, UPDATE } from '@kubernetes/client-node/dist/informer.js';
import { KubernetesObject } from '@kubernetes/client-node/dist/types.js';
import { Watch } from '@kubernetes/client-node/dist/watch.js';
